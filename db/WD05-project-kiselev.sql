...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 08 2019 г., 14:10
...
(5, 18, 4, 'Замечательный парк', '2019-02-06 14:47:58'),
(6, 18, 4, 'Обязательно вернусь туда снова в следующем году.', '2019-02-06 14:50:34'),
(7, 18, 8, 'Классный парк', '2019-02-06 21:27:04');
...
(1, 'ser-kiselev84@mail.ru', '+7 (920) 259 01 67', '', 'Сергей', 'Киселев', '', '', '', '', '');
...
(1, 'Василий', 'vasya@vasya.com', 'Привет!');
...
(17, 'Samsung случайно показал свой первый смартфон с&nbsp;гибким экраном', 'В Сети появилось видео, на котором показан первый смартфон Samsung со складным экраном. Об этом сообщает портал Xda Developers.\r\n\r\nРолик появился в аккаунтах вьетнамского подразделения компании в соцсетях. Позже видео удалили.\r\nНа кадры попали новинки компании, которые, как ожидается, будут представлены на видеоконференции Samsung Unpacked. Мероприятие запланировано на 20 февраля.\r\n\r\nСудя по видео, у новой модели будет внутренний и наружный дисплеи, которые можно будет соединить в один экран. В то же время финальный дизайн смартфона может отличаться от того, что разработчики показали в ролике, отмечает издание.', 8, '2019-02-01 20:37:57', NULL, NULL, 4, NULL),
(18, 'Заметка 4', '<p>бла бла бла 125456456444</p>\r\n', 8, '2019-02-04 20:49:42', '-319220218.jpg', '320--319220218.jpg', 4, '2019-02-06 14:29:41');
